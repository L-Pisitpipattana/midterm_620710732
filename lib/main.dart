  ...
  Widget build(BuildContext context){
    return Scaffold(
      body: Container(
        ...
        Text(
          "PIG WEIGHT",
          style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30.0, color: Colors.pinkAccent),
        ),
      Row(
            ...
            child: Center(
                    ...
                    Expanded(
                      child: Card(
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              const Text('LENGTH', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18.0)),
                              const Text('(cm)', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17.0)),
                    ...
                    Expanded(
                      child: Card(
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              const Text('GIRTH', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18.0)),
                              const Text('(cm)', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17.0)),
              ...
              Padding(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('CALCULATE',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18.0)),
                  onPressed: () {
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            title: Row(
                              children: [
                                Image.asset('assets/images/ic_pig.png',height: 30.0,),Text('RESULT'),
                              ],
                            ),
